...
(function() {
  var AbstractRouteTable, RouteSegment, RouteTable, runTables,
  ...
  RouteTable = (function(_super) {
    ...
    RouteTable.prototype.segment_as_array = function(segment) {
      return [segment.id, this.segment_name_from_points(segment), this.miles(segment), this.elevation(segment), this.reverse_elevation(segment)];
    };
